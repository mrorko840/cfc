...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['totalMatch'] = Result::count();
    ...
    public function ajaxNoti(Request $request){
        
        $data = array();
        $json = array();
        $data['adminNotifications'] = AdminNotification::where('read_status',0)->with('user')->take(20)->orderBy('id','desc')->get();
        
        $json['html'] =  view('admin.partials.ajax_noti', $data)->render();
        $json['count'] = AdminNotification::where('read_status',0)->with('user')->orderBy('id','desc')->count();
