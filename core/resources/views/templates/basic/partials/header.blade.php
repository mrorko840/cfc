        ...
        <div class="header-top-wrapper">
            ...
            @auth
                <div class="right-area d-none d-md-block">
                    <a href="{{route('user.home')}}" class="cmn--btn btn--sm mr-3">@lang('Dashboard')</a>
                     <a href="{{route('user.logout')}}" class="cmn--btn btn--sm mr-3" style="background: red;">
            ...
            @else
                <div class="right-area d-none d-md-block">
                    ...
                    <a href="{{route('user.login')}}" class="cmn--btn btn--sm" style="background:green">
                        <i class="las la-user"></i>
...
<div class="header-bottom bg--section">
    <div class="container">
        <div class="header__wrapper">
            ...
            @auth
            <a class="btn btn-success d-lg-none" href="{{ route('user.deposit') }}">Deposit</a>
            @endif
            ...
            <div class="menu-area align-items-center ">
                ...
                <div class="right-area d-md-none text-center mb-4">
                    @auth
                        <a href="{{route('user.home')}}" class="cmn--btn btn--sm mr-3">@lang('Dashboard')</a>
                        <a href="{{route('user.logout')}}" class="text--white cmn--btn btn--sm mr-3" style="background:red">
                            <i class="las la-user"></i>
                            <span>@lang('Logout')</span>
                        </a>
                    @else
                        <a href="{{route('user.register')}}" class="cmn--btn btn--sm mr-3">@lang('Register')</a>
                        <a href="{{route('user.login')}}" class="text--white cmn--btn btn--sm mr-3" style="background:green">
                            <i class="las la-user"></i>
                            <span>@lang('Login Now')</span>
                        </a>
                    @endauth
                ...
                <ul class="menu">
                    ...
                    <li class="d-none d-md-block"><a class="btn btn-success" href="{{ route('user.deposit') }}">Deposit</a>
                    </li>
