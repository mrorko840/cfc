                                ...
                                @forelse ($matches as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                         ...
                                         @if ( $item->status == 1 )
                                         <a data-id="{{$item->id}}" title="Make Winner" class="mw icon-btn btn--info"><i class="la la-question"></i></a>
                                        @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> @lang('Choose which score will loose')</h5>
                ...
                <form action="{{route('admin.match.winner')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold">@lang('Select Loosing Score') <span class="text-danger">*</span></label>
