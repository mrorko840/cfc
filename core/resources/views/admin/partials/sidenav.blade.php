    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <!--{{menuActive('admin.frontend.sections', 'notice')}}-->
                ">
                ...
                <li class="sidebar-menu-item 
                <!--{{menuActive('admin.frontend.sections', 'fake_count')}}-->
                ">
                    <a href="{{route('admin.frontend.sections', 'fake_count')}}" class="nav-link ">
                        <i class="menu-icon fas fa-link"></i>
                        <span class="menu-title">@lang('Fake Counter')</span>
                    </a>
                </li>
                @endif
                @if( $adminType == 'superadmin' || $adminType == 'admin' )
            ...
            <div class="text-center mb-3 text-uppercase">
                ...
                <a href="https://wa.me/17724447213">
                    <img src="https://i.ibb.co/xDqH098/amirican-it.png" width="100px" alt="American IT">
                    <!--<span class="text-warning">American IT</span>-->
                </a>
