        ...
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('VIP Level')
                            <!--<span class="font-weight-bold">@if($user->vip_level != null){{$user->vip_level}} @else {{ 'N/A' }} @endif</span>-->
                        <span class="font-weight-bold">{{ get_user_vip_level($user->id) }}</span
                        </li>
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.users.notification',$user->id)}}" class="btn btn--success btn--shadow btn-block btn-lg">
                        @lang('Send Notification')
                    </a>
                    
                    <a href="{{route('admin.users.notification.log',$user->id)}}" class="btn btn--danger btn--shadow btn-block btn-lg">
                        @lang('Notification Log')
                    </a>
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                             ...
                             <div class="col-xs-12 col-md-6">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('VIP LEVEL') </label>
                                    <select name="vip_level" class="form-control">
                                        @for($i = 0; $i<=7; $i++)
                                        <option value="VIP {{ $i }}"
                                        @php
                                        if ( get_user_vip_level($user->id) == 'VIP '.$i ){
                                        echo 'selected';
                                        }
                                        @endphp
                                        > VIP {{ $i }} </option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group ">
                                    <input type="text" name="description" class="form-control" placeholder="@lang('Please provide description')">
                                </div>
