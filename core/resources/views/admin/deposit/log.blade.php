                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Gateway | Trx')">
                                    ...
                                    @if ( !blank($deposit->gateway) )
                                     <span class="font-weight-bold"> 
                                     
                                     <a href="{{ route('admin.deposit.method',[$deposit->gateway->alias,'all']) }}">{{ __($deposit->gateway->name) }}</a> </span>
                                     <br>
                                     @endif
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="@if( $adminType == 'superadmin' ){{ route('admin.users.detail', $deposit->user_id) }}@endif"><span>@</span>{{ $deposit->user->username }}</a>
                                    </span>
                                </td>
