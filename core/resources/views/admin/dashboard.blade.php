        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 mb-30">
            <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.users.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--5 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.users.email.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--danger b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.users.sms.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        --}}
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--8 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.category.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--10 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.league.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--18 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.match.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.bet.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3 <?php if($adminType != 'superadmin'){ echo "disabled"; } ?>">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
